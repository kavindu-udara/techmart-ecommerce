...
const UpdateProductDialog = ({product, triggerRef}: Props) => {
    ...
    const handleSubmit = () => {
        ...
        apiClient.put(`/admin/products/${product.id}`, formData)
            .then(() => {
                toast.success("Product updated successfully!");
                triggerRef.current?.click(); // Close the dialog
                window.location.reload(); // Refresh the page to show the updated product
            })
            .catch((error) => {
